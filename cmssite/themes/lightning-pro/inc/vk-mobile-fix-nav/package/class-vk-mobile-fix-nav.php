	...
	class Vk_Mobile_Fix_Nav {
		...
		public function vk_mobil_fix_nav_customize_register( $wp_customize ) {
			...
			$wp_customize->add_control(
				'vk_mobil_fix_nav_options[hidden]',
				array(
					'label'    => __( 'Do not display Mobile Fix Nav', 'lightning-pro' ),
			...
			$wp_customize->add_control(
				new MobileNav_Custom_Html(
					...
					'nav_title_widget',
					array(
						'label'            => __( 'Mobile Fix Nav Widget Area', 'lightning-pro' ),
						'section'          => 'vk_mobil_fix_nav_setting',
						'type'             => 'text',
						'custom_title_sub' => '',
						'custom_html'      => '',
			...
			$wp_customize->add_control(
				'vk_mobil_fix_nav_options[widget_padding]',
				array(
					'label'    => __( 'Add Widget Area Padding', 'lightning-pro' ),
					'section'  => 'vk_mobil_fix_nav_setting',
			...
			$wp_customize->add_control(
				new MobileNav_Custom_Html(
					...
					'nav_title_0',
					array(
						'label'            => __( 'Add menu open and close button', 'lightning-pro' ),
						'section'          => 'vk_mobil_fix_nav_setting',
						'type'             => 'text',
						'custom_title_sub' => '',
						'custom_html'      => '',
			...
			$wp_customize->add_control(
				'vk_mobil_fix_nav_options[add_menu_btn]',
				array(
					'label'       => __( 'Add menu open and close button to first.', 'lightning-pro' ),
					'section'     => 'vk_mobil_fix_nav_setting',
					'settings'    => 'vk_mobil_fix_nav_options[add_menu_btn]',
					'type'        => 'checkbox',
					'description' => __( '* When using Font Awesome 5 SVG, the icon does not switch at menu open.', 'lightning-pro' ),
				)
			);
			...
			if ( isset( $add_menu_btn ) && $add_menu_btn == true ) {
				...
				$wp_customize->add_control(
					'link_text_0',
					array(
						'label'    => __( 'Link text:', 'lightning-pro' ),
						'section'  => 'vk_mobil_fix_nav_setting',
			...
			for ( $i = 1; $i <= $menu_num; $i ++ ) {
				...
				$wp_customize->add_control(
					new MobileNav_Custom_Html(
						...
						'nav_title_' . $i,
						array(
							'label'            => __( 'Fix Navi button', 'lightning-pro' ) . ' [ ' . $i . ' ]',
							'section'          => 'vk_mobil_fix_nav_setting',
							'type'             => 'text',
							'custom_title_sub' => '',
							'custom_html'      => '',
				...
				$wp_customize->add_control(
					'link_icon_' . $i,
					array(
						'label'       => __( 'Icon font class name:', 'lightning-pro' ),
						'section'     => 'vk_mobil_fix_nav_setting',
				...
				$wp_customize->add_control(
					...
					array(
						...
						'type'        => 'text',
						'description' => __( 'Ex', 'lightning-pro' ) . ') https://vccw.text/',
					)
				);
				...
				$wp_customize->add_control(
					'vk_mobil_fix_nav_options[link_blank_' . $i . ']',
					array(
						'label'    => __( 'Open link new tab.', 'lightning-pro' ),
						'section'  => 'vk_mobil_fix_nav_setting',
				...
				$wp_customize->add_control(
					'event_' . $i,
					array(
						'label'       => __( 'Click event:', 'lightning-pro' ),
						'section'     => 'vk_mobil_fix_nav_setting',
						'settings'    => 'vk_mobil_fix_nav_options[event_' . $i . ']',
						'type'        => 'text',
						'description' => __( 'Ex', 'lightning-pro' ) . ") ga('send', 'event', 'Videos', 'play', 'Fall Campaign');",
					)
				);
				...
				$wp_customize->add_control(
					new MobileNav_Custom_Html(
						...
						'nav_common',
						array(
							'label'            => __( 'Navi Common Settings', 'lightning-pro' ),
							'section'          => 'vk_mobil_fix_nav_setting',
							'type'             => 'text',
							'custom_title_sub' => '',
							'custom_html'      => '',
			...
			$wp_customize->add_control(
				new WP_Customize_Color_Control(
					...
					'current_color',
					array(
						'label'    => __( 'Current Color:', 'lightning-pro' ),
						'section'  => 'vk_mobil_fix_nav_setting',
