...
function lightning_customize_register_top_slide( $wp_customize ) {
	...
	$wp_customize->add_section(
		'lightning_slide',
		array(
			'title'    => lightning_get_prefix_customize_panel() . __( 'Home page slide show', 'lightning-pro' ),
			'priority' => 520,
	...
	$wp_customize->add_control(
		'lightning_theme_options[top_slide_hide]',
		array(
			'label'    => __( 'Hide slide', 'lightning-pro' ),
	...
	$wp_customize->add_control(
		new Custom_Text_Control(
			...
			'top_slide_time',
			array(
				'label'       => __( 'Slide interval time', 'lightning-pro' ),
				'section'     => 'lightning_slide',
				'settings'    => 'lightning_theme_options[top_slide_time]',
				'type'        => 'text',
				'priority'    => 605,
				'description' => '',
				'input_after' => __( 'millisecond', 'lightning-pro' ),
			)
		)
	);
	...
	for ( $i = 1; $i <= $top_slide_count_max; ) {
		...
		$wp_customize->add_control(
			new WP_Customize_Image_Control(
				...
				'top_slide_image_' . $i,
				array(
					'label'       => '[' . $i . '] ' . __( 'Slide image', 'lightning-pro' ),
					'section'     => 'lightning_slide',
					'settings'    => 'lightning_theme_options[top_slide_image_' . $i . ']',
					'priority'    => $priority,
					'description' => __( 'Recommended image size : 1900*600px', 'lightning-pro' ),
				)
			)
		);
		...
		$wp_customize->add_control(
			new WP_Customize_Image_Control(
				...
				array(
					'label'       => '[' . $i . '] ' . __( 'Slide image for mobile', 'lightning-pro' ) . ' (' . __( 'optional', 'lightning-pro' ) . ')',
					'section'     => 'lightning_slide',
		...
		$wp_customize->add_control(
			new Custom_Text_Control(
				...
				'top_slide_alt_' . $i,
				array(
					'label'       => '[' . $i . '] ' . __( 'Slide image alt', 'lightning-pro' ),
					'section'     => 'lightning_slide',
					'settings'    => 'lightning_theme_options[top_slide_alt_' . $i . ']',
					'type'        => 'text',
					'priority'    => $priority,
					'description' => __( 'This title text is print to alt tag.', 'lightning-pro' ),
				)
			)
		);
		...
		$wp_customize->add_control(
			new WP_Customize_Color_Control(
				...
				array(
					'label'    => '[' . $i . '] ' . __( 'Slide cover color', 'lightning-pro' ) . ' (' . __( 'optional', 'lightning-pro' ) . ')',
					'section'  => 'lightning_slide',
		...
		$wp_customize->add_control(
			new Custom_Text_Control(
				...
				array(
					'label'       => '[' . $i . '] ' . __( 'Slide cover opacity', 'lightning-pro' ),
					'section'     => 'lightning_slide',
					'settings'    => 'lightning_theme_options[top_slide_cover_opacity_' . $i . ']',
					'type'        => 'text',
					'priority'    => $priority,
					'description' => __( 'Please input 0 - 100 number', 'lightning-pro' ),
					'input_after' => '%',
				)
			)
		);
			...
			$wp_customize->add_control(
				'top_slide_url_' . $i,
				array(
					'label'    => '[' . $i . '] ' . __( 'Slide image link url', 'lightning-pro' ),
					'section'  => 'lightning_slide',
			...
			$wp_customize->add_control(
				'lightning_theme_options[top_slide_link_blank_' . $i . ']',
				array(
					'label'    => __( 'Open in new window.', 'lightning-pro' ),
					'section'  => 'lightning_slide',
		...
		$wp_customize->add_control(
			...
			array(
				'label'       => '[' . $i . '] ' . __( 'Slide title', 'lightning-pro' ) . ' (' . __( 'optional', 'lightning-pro' ) . ')',
				'section'     => 'lightning_slide',
		...
		$wp_customize->add_control(
			...
			array(
				'label'       => '[' . $i . '] ' . __( 'Slide text', 'lightning-pro' ) . ' (' . __( 'optional', 'lightning-pro' ) . ')',
				'section'     => 'lightning_slide',
		...
		$wp_customize->add_control(
			new Custom_Text_Control(
				...
				array(
					'label'       => '[' . $i . '] ' . __( 'Button text', 'lightning-pro' ) . ' (' . __( 'optional', 'lightning-pro' ) . ')',
					'section'     => 'lightning_slide',
					'settings'    => 'lightning_theme_options[top_slide_text_btn_' . $i . ']',
					'type'        => 'text',
					'priority'    => $priority,
					'description' => __( 'If you do not fill in the link url and button text that, button is do not display.', 'lightning-pro' ),
				)
			)
		);
		...
		$wp_customize->add_control(
			...
			array(
				'label'    => '[' . $i . '] ' . __( 'Position to display text', 'lightning-pro' ) . ' (' . __( 'optional', 'lightning-pro' ) . ')',
				'section'  => 'lightning_slide',
				...
				'choices'  => array(
					...
					'center' => __( 'Center', 'lightning-pro' ),
		...
		$wp_customize->add_control(
			new WP_Customize_Color_Control(
				...
				array(
					'label'    => '[' . $i . '] ' . __( 'Slide text color', 'lightning-pro' ) . ' (' . __( 'optional', 'lightning-pro' ) . ')',
					'section'  => 'lightning_slide',
		...
		$wp_customize->add_control(
			'lightning_theme_options[top_slide_text_shadow_use_' . $i . ']',
			array(
				'label'    => __( 'Use text shadow', 'lightning-pro' ) . ' (' . __( 'optional', 'lightning-pro' ) . ')',
				'section'  => 'lightning_slide',
		...
		$wp_customize->add_control(
			new WP_Customize_Color_Control(
				...
				array(
					'label'    => '[' . $i . '] ' . __( 'Text shadow color', 'lightning-pro' ) . ' (' . __( 'optional', 'lightning-pro' ) . ')',
					'section'  => 'lightning_slide',
