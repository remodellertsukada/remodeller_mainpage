...
function lightning_add_design_meta_box() {
	...
	foreach ( $post_types as $post_type => $value ) {
		add_meta_box(
			...
			__( 'Lightning design setting', 'lightning-pro' ),
...
function lightning_design_setting_meta_fields() {
	...
	/*
	  Layout setting
	/*-------------------------------------------*/
	echo '<h4>' . __( 'Layout setting', 'lightning-pro' ) . '</h4>';
	...
	/*
	  .Page Header
	/*-------------------------------------------*/
	$form .= '<h4>' . __( 'Page Header and Breadcrumb', 'lightning-pro' ) . '</h4>';
	...
	$form .= '<li class="vk_checklist_item vk_checklist_item-style-vertical">' . '<input type="checkbox" id="' . $id . '" name="' . $id . '" value="true"' . $checked . '  class="vk_checklist_item_input"><label for="' . $id . '" class="vk_checklist_item_label">' . wp_kses_post( __( 'Don\'t display Page Header', 'lightning-pro' ) ) . '</label></li>';
	...
	$form .= '<li class="vk_checklist_item vk_checklist_item-style-vertical">' . '<input type="checkbox" id="' . $id . '" name="' . $id . '" value="true"' . $checked . '  class="vk_checklist_item_input"><label for="' . $id . '" class="vk_checklist_item_label">' . wp_kses_post( __( 'Don\'t display Breadcrumb', 'lightning-pro' ) ) . '</label></li>';
