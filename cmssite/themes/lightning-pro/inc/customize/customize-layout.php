...
function lightning_customize_register_layout( $wp_customize ) {
	...
	$page_types = array(
		...
		'archive' => array(
			'label' => __( 'Archive page (Post and custom post type)', 'lightning-pro' ),
		),
		'single' => array(
			'label' => __( 'Single page (Post and custom post type)', 'lightning-pro' ),
		),
	...
	$wp_customize->add_control(
		'lightning_theme_options[sidebar_fix]', array(
			'label'    => __( 'Don\'t fix the sidebar', 'lightning-pro' ),
			'section'  => 'lightning_layout',
	...
	$wp_customize->add_control(
		new Custom_Html_Control(
			$wp_customize, 'ltg_sidebar_display_setting_title', array(
				...
				'section'          => 'lightning_layout',
				'type'             => 'text',
				'custom_title_sub' => __( 'Sidebar display', 'lightning-pro' ) . ' ( ' . __( 'One-column mode', 'lightning-pro' ).' )',
