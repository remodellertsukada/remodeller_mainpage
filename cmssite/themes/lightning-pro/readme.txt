...
* [ Add function ][ Media Posts BS4 Widget ] Add Card (nonorder) layout and add display taxonomy
...
v7.9.2
* [ Design Bug fix ] Slide text alignbug fix ( under h3 design selected both-end )

v7.9.1
* [ Add function ] Add CSS all optimize ( preload )

v7.8.3
* [ Bug fix ] Don't refrect post column at xl(on xxl) size
* [ Design bug fix ] fix post media loop item border

v7.8.2
* [ Design bug fix ][ tree shaking ][ card ] exclude imageRound and no-border
* [ Design bug fix ][ woo ] add special item block btn border
...
v7.8.0
* [ bug fix ][ breadcrumb ] fix and add test
* [ add filter ] vk_mobil_fix_nav_options
...
v7.5.0
* [ Add function ][ Media Posts BS4 ] Add post order / orderby title
* [ Delete function ] comment setting( since 7.0.0 )
...
v7.3.5
* [ Desigin Bug fix ] Fixed a bug where headings were moved to the left of the screen

v7.3.4
* [ Desigin Bug fix ] woocommerce product block cart button tuning

v7.3.3
* [ Desigin Bug fix ] woocommerce subscription details text tuning
...
v7.3.0
* [ Add function ][ Header top ] Add Icon setting
* [ Other ][ Headding design ] Cope with editor screen
...
* [ Bug fix ][ PostList text ] post title don't br on mobile
* [ Bug fix ][ Slidebar ] Cope with headding desigin changed
* [ Bug fix ][ Slidebar ] Edit shortcut icon position
...
v7.1.1
* [ Bug fix ][ slide title ] When set h3 title dsign that the slide title align doesn't refrect.
* [ Bug fix ] Archive page card column number at xxl size.
...
* [ Other ][ font family ] Cope with editor screen
...
v6.4.8
* [ Bug fix ] marge_css and marge_functions run

v6.4.7
* [ Bug fix ] Full width adjustment editor screen

v6.4.6
* [ Bug fix ] Cope with ExUnit and VK Blocks CSS Optimize

v6.4.5
* [ Bug fix ] Fix get_the_date() fitst argument on WP5.5

v6.4.4
* [ Bug fix ] In partly Key Color don't work bug fix

v6.4.3
* [ Bug fix ] Card image link don't work by tree shaking

v6.4.2
* [ BugFix ][ headerTop ] HeaderTop Custom Color don't work.

v6.4.1
* [ Specification Change ] Change header top customize css print point
...
v6.1.1
* [ Specification Change ] Footer border color miner change
...
* [ Add Function ] Footer color setting
* [ Specification Change ] Rebuild Sidebar Fix logic and option

v5.2.2
* [ Bug fix ] campaign text button link bug(Japanese url) fix

v5.2.1
* [ Bug fix ] campaign text button link text color

v5.2.0
* [ Specification Change ] Add link to page sidebar parent page name

v5.1.0
* [ Add Setting ][ header top ] Add contact btn link target
