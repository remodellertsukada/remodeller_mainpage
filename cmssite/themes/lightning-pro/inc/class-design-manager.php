...
class Lightning_Design_Manager {
	...
	static function get_skins() {
		$skins = array(
			'origin'  => array(
				'label'           => __( 'Origin ( Not recommended )', 'lightning-pro' ),
			...
			'origin2' => array(
				'label'           => __( 'Origin II ( Bootstrap4 )', 'lightning-pro' ),
	...
	static function customize_register( $wp_customize ) {
		...
		$wp_customize->add_control(
			'lightning_design_skin',
			array(
				'label'       => __( 'Design skin', 'lightning-pro' ),
				'section'     => 'lightning_design',
				'settings'    => 'lightning_design_skin',
				'description' => '<span style="color:red;font-weight:bold;">' . __( 'If you change the skin, please save once and reload the page.', 'lightning-pro' ) . '</span><br/>' .
					__( 'If you reload after the saving, it will be displayed skin-specific configuration items.', 'lightning-pro' ) . '<br/> ' .
					__( '*There is also a case where there is no skin-specific installation item.', 'lightning-pro' ),
				'type'        => 'select',
				'priority'    => 100,
				'choices'     => $skins,
			)
