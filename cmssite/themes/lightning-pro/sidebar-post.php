...
<h1 class="subSection-title"><?php echo __( 'Recent posts', 'lightning-pro' ); ?></h1>
<?php
...
<nav class="localNav">
<h1 class="subSection-title"><?php _e( 'Category', 'lightning-pro' ); ?></h1>
<ul>
...
<nav class="localNav">
<h1 class="subSection-title"><?php _e( 'Archive', 'lightning-pro' ); ?></h1>
<ul>
	<?php
	$args = array(
		'type'      => 'monthly',
