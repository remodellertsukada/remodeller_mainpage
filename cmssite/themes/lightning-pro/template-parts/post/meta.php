...
<span class="entry-meta_items entry-meta_updated<?php echo $meta_hidden_update; ?>">/ <?php _e( 'Last updated', 'lightning-pro' ); ?> : <span class="updated"><?php the_modified_date( '' ); ?></span></span>
