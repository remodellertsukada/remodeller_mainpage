...
function lightning_customize_register_design( $wp_customize ) {
	...
	$wp_customize->add_section(
		'lightning_design',
		array(
			'title'    => lightning_get_prefix_customize_panel() . __( 'Design settings', 'lightning-pro' ),
			'priority' => 501,
	...
	$wp_customize->add_control(
		new WP_Customize_Image_Control(
			...
			'head_logo',
			array(
				'label'       => __( 'Header logo image', 'lightning-pro' ),
	...
	*/
	...
	$wp_customize->add_control(
		new Custom_Html_Control(
			...
			'color_header',
			array(
				'label'            => __( 'Color Setting', 'lightning-pro' ),
				'section'          => 'lightning_design',
				'type'             => 'text',
				'custom_title_sub' => __( 'Key Color', 'lightning-pro' ),
				'custom_html'      => '',
				'priority'         => 600,
			)
		)
	...
	$wp_customize->add_control(
		new WP_Customize_Color_Control(
			...
			'color_key',
			array(
				'label'    => __( 'Key color', 'lightning-pro' ),
				'section'  => 'lightning_design',
	...
	$wp_customize->add_control(
		new WP_Customize_Color_Control(
			...
			'color_key_dark',
			array(
				'label'    => __( 'Key color (dark)', 'lightning-pro' ),
				'section'  => 'lightning_design',
	...
	$wp_customize->add_control(
		new Custom_Html_Control(
			...
			array(
				...
				'section'          => 'lightning_design',
				'type'             => 'text',
				'custom_title_sub' => __( 'Link text color', 'lightning-pro' ),
				'custom_html'      => '',
				'priority'         => 600,
			)
		)
	...
	$wp_customize->add_control(
		new WP_Customize_Color_Control(
			...
			'lightning_theme_options[link_text_color_default]',
			array(
				'label'    => __( 'Link text color ( default )', 'lightning-pro' ),
				'section'  => 'lightning_design',
	...
	$wp_customize->add_control(
		new WP_Customize_Color_Control(
			...
			'lightning_theme_options[link_text_color_hover]',
			array(
				'label'    => __( 'Link text color ( hover )', 'lightning-pro' ),
				'section'  => 'lightning_design',
	...
	// 		'lightning_theme_options[link_text_color_visited]',
	// 		array(
	// 			'label'    => __( 'Link text color ( visited )', 'lightning-pro' ),
	// 			'section'  => 'lightning_design',
	...
	*/
	...
	$wp_customize->add_control(
		new Custom_Html_Control(
			...
			'layout',
			array(
				'label'            => __( 'Layout Setting', 'lightning-pro' ),
				'section'          => 'lightning_design',
				'type'             => 'text',
				'custom_title_sub' => '',
				'custom_html'      => '<p>' . __( 'This setting field was moved to the "Layout Setting" panel.', 'lightning-pro' ) . '</p>',
				'priority'         => 700,
			)
		)
	);
	...
	$wp_customize->add_control(
		new Custom_Html_Control(
			...
			'Others',
			array(
				'label'            => __( 'Other Setting', 'lightning-pro' ),
				'section'          => 'lightning_design',
				'type'             => 'text',
				'custom_title_sub' => '',
				'custom_html'      => '',
	...
	$wp_customize->add_control(
		'lightning_theme_options[top_default_content_hidden]',
		array(
			'label'    => __( 'Don\'t show default content(Post list or Front page) at home page', 'lightning-pro' ),
			'section'  => 'lightning_design',
	...
	$wp_customize->add_control(
		'lightning_theme_options[postUpdate_hidden]',
		array(
			'label'    => __( 'Hide modified date on single pages.', 'lightning-pro' ),
			'section'  => 'lightning_design',
	...
	$wp_customize->add_control(
		'lightning_theme_options[postAuthor_hidden]',
		array(
			'label'    => __( 'Don\'t display post author on a single page', 'lightning-pro' ),
			'section'  => 'lightning_design',
	...
	$wp_customize->add_control(
		'lightning_theme_options[sidebar_child_list_hidden]',
		array(
			'label'    => __( 'Don\'t display grandchild page of deactive page at page sidebar.', 'lightning-pro' ),
			'section'  => 'lightning_design',
