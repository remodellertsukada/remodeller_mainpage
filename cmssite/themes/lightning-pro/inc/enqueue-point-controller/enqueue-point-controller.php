...
function lightning_customize_register_enqueue_point( $wp_customize ) {
	...
	$wp_customize->add_control(
		new Custom_Html_Control(
			...
			'enqueue_point_title',
			array(
				'label'            => __( 'CSS and JavaScript load point ', 'lightning-pro' ),
	...
	$wp_customize->add_control(
		'lightning_theme_options[enqueue_point_footer]',
		array(
			'label'       => __( 'Move to footer', 'lightning-pro' ),
			'section'     => 'lightning_function',
			'settings'    => 'lightning_theme_options[enqueue_point_footer]',
			'type'        => 'checkbox',
			'description' => __( 'If you enabled this checkbox that page loading speed become little faster.', 'lightning-pro' ),
		)
	);
