...
function lightning_woo_customize_register( $wp_customize ) {
	...
	$wp_customize->add_control(
		new Custom_Html_Control(
			...
			'ltg_woo_image_setting',
			array(
				'label'            => __( 'Border Setting', 'lightning-pro' ) .' ('.lightning_get_theme_name().')',
				'section'          => 'woocommerce_product_images',
				'type'             => 'text',
				'custom_title_sub' => __( 'Add border to item image', 'lightning-pro' ), 
				'custom_html'      => '',
				'priority'         => 600,
			)
		)
	...
	$wp_customize->add_control(
		'lightning_woo_options[image_border_archive]',
		array(
			'label'    => __( 'Item list section', 'lightning-pro' ),
			'section'  => 'woocommerce_product_images',
	...
	$wp_customize->add_control(
		'lightning_woo_options[image_border_single]',
		array(
			'label'    => __( 'Single page', 'lightning-pro' ),
			'section'  => 'woocommerce_product_images',
