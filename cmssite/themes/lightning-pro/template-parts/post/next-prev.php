...
if ( $bootstrap == '4' ) {
	...
	<div class="vk_posts postNextPrev">
		...
		<?php
		if ( $post_previous ) {
			$options['body_prepend'] = '<p class="postNextPrev_label">' . __( 'Previous article', 'lightning-pro' ) . '</p>';
		...
		<?php
		if ( $post_next ) {
			$options['body_prepend'] = '<p class="postNextPrev_label">' . __( 'Next article', 'lightning-pro' ) . '</p>';
