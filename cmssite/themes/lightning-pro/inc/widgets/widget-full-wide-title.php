...
class LTG_Theme_Full_Wide_Title extends WP_Widget {
	function __construct() {
		...
		$widget_name        = lightning_get_prefix() . __( 'Full Wide Title', 'lightning-pro' );
		$widget_description = array( 'description' => __( 'This widget is used for single column only.', 'lightning-pro' ) );
	...
	public function form( $instance ) {
		...
		echo '<p>';
		echo  __( 'Title:', 'lightning-pro' ) . '<br>';
		...
		echo '<p>';
		echo  __( 'Sub title:', 'lightning-pro' ) . '<br>';
		echo '<textarea id="' . $id . '" name="' . $name . '" style="width:100%;">' . esc_textarea( $text ) . '</textarea>';
		echo '</p>';

		// title font color
		echo '<p class="color_picker_wrap">' .
			 '<label for="' . $this->get_field_id( 'title_font_color' ) . '">' . __( 'Text color of the title:', 'lightning-pro' ) . '</label><br/>' .
		...
		echo '<label for="' . $this->get_field_id( 'title_shadow_use' ) . '">' . __( 'Text shadow', 'lightning-pro' ) . '</label><br/></p>';

		// Shadow color
		echo '<p class="color_picker_wrap">' .
			 '<label for="' . $this->get_field_id( 'title_shadow_color' ) . '">' . __( 'Text shadow color:', 'lightning-pro' ) . '</label><br/>' .
		...
		// bg color
		echo '<p class="color_picker_wrap">' .
			 '<label for="' . $this->get_field_id( 'title_bg_color' ) . '">' . __( 'Title background color:', 'lightning-pro' ) . '</label><br/>' .
		...
		<div class="vkExUnit_banner_area" style="padding: 0.7em 0;">
			...
			<button class="button button-default button-block" style="display:block;width:100%;text-align: center; margin:4px 0;" onclick="javascript:vk_title_bg_image_addiditional(this);return false;"><?php _e( 'Set image', 'lightning-pro' ); ?></button>
		...
		echo '<label for="' . $this->get_field_id( 'bg_parallax' ) . '">' . __( 'Set to parallax', 'lightning-pro' ) . '</label><br/></p>';

		echo '<p>';
		echo  __( 'Margin Top', 'lightning-pro' ) . ' : ';
		...
		echo __( 'Ex', 'lightning-pro' ) . ') 0;';
		echo '</p>';

		echo '<p>';
		echo  __( 'Margin Bottom', 'lightning-pro' ) . ' : ';
