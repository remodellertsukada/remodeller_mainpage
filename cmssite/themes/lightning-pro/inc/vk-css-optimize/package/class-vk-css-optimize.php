	...
	class VK_CSS_Optimize {
		...
		public static function customize_register( $wp_customize ){
			...
			$wp_customize->add_section(
				'css_optimize', array(
					'title'    => $prefix_customize_panel . __( 'CSS Optimize ( Speed up ) Settings', 'lightning-pro' ),
					'priority' => 450,
				)
			);
			...
			$wp_customize->add_control(
				new Custom_Html_Control(
					...
					'tree_shaking_title',
					array(
						'label'            => __( 'Tree shaking', 'lightning-pro' ),
						'section'          => 'css_optimize',
						'type'             => 'text',
						'custom_title_sub' => '',
						// 'custom_html'      => __( 'Move part of CSS and JS to the footer to improve display speed.', 'lightning-pro' ),
					)
				)
			);
			...
			$wp_customize->add_control(
				'vk_css_optimize_options[tree_shaking]',
				array(
					'label'    		=> __( 'Tree shaking activation settings', 'lightning-pro' ),
					'section'  		=> 'css_optimize',
					'settings' 		=> 'vk_css_optimize_options[tree_shaking]',
					'type'     		=> 'select',
					'description'	=> __( 'Output only the main CSS of the page inline', 'lightning-pro' ),
					'choices'  => array(
						''			=> __( 'Nothing to do', 'lightning-pro' ),
						'active'	=> __( 'Active Tree shaking (Recomend)', 'lightning-pro' ),
					),
				)
			);
			...
			$wp_customize->add_control(
				'vk_css_optimize_options[tree_shaking_class_exclude]',
				array(
					'label'       => __( 'Exclude class of Tree shaking', 'lightning-pro' ),
					'section'     => 'css_optimize',
					'settings'    => 'vk_css_optimize_options[tree_shaking_class_exclude]',
					'type'        => 'textarea',
					'description' => __( 'If you choose "Active Tree shaking" that delete the useless css.If you using active css class that please fill in class name. Ex) btn-active,slide-active,scrolled', 'lightning-pro' ),
				)
			);
			...
			$wp_customize->add_control(
				new Custom_Html_Control(
					...
					'css_preload_title',
					array(
						'label'            => __( 'Preload CSS', 'lightning-pro' ),
						'section'          => 'css_optimize',
						'type'             => 'text',
						'custom_title_sub' => '',
						// 'custom_html'      => __( 'Move part of CSS and JS to the footer to improve display speed.', 'lightning-pro' ),
			...
			$wp_customize->add_control(
				'vk_css_optimize_options[preload]',
				array(
					'label'       => __( 'Preload CSS activation settings', 'lightning-pro' ),
					'section'     => 'css_optimize',
					'settings'    => 'vk_css_optimize_options[preload]',
					'description' => __( 'Preload css except for critical css', 'lightning-pro' ),
					'type'        => 'select',
					'choices'  => array(
						''   	 	=> __( 'Nothing to do', 'lightning-pro' ),
						'active'    => __( 'Active Preload CSS (Recomend)', 'lightning-pro' ),
					),
				)
			);
			...
			$wp_customize->add_control(
				'vk_css_optimize_options[preload_handle_exclude]',
				array(
					'label'       => __( 'Exclude class of Preload CSS', 'lightning-pro' ),
					'section'     => 'css_optimize',
