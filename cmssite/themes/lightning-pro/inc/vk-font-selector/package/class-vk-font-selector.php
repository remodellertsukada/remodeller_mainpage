...
if ( ! class_exists( 'Vk_Font_Selector_Customize' ) ) {
	...
	class Vk_Font_Selector_Customize {
		...
		public static function fonts_array() {
			$fonts_array = array(
				''                      => array(
					'label'       => __( 'Unspecified', 'lightning-pro' ),
					'font-family' => '',
				),
				'mincho'                => array(
					'label'       => __( 'Mincho', 'lightning-pro' ),
					'font-family' => 'Hiragino Mincho ProN,"游明朝",serif',
				),
				'hira-kaku'             => array(
					'label'       => __( 'Hiragino Kaku Gothic', 'lightning-pro' ),
				...
				'yu-gothic'             => array(
					'label'       => __( 'Yu Gothic', 'lightning-pro' ),
					'font-family' => '"游ゴシック Medium","Yu Gothic Medium","游ゴシック体",YuGothic,"ヒラギノ角ゴ ProN W3", Hiragino Kaku Gothic ProN,sans-serif',
				),
				'meiryo'                => array(
					'label'       => __( 'Meiryo', 'lightning-pro' ),
					'font-family' => '"メイリオ",Meiryo,"ヒラギノ角ゴ ProN W3", Hiragino Kaku Gothic ProN,sans-serif',
				),
				'san-francisco'         => array(
					'label'       => __( 'San Francisco', 'lightning-pro' ),
		...
		public static function target_array() {
			$target_array = array(
				...
				'menu'  => array(
					'label'    => __( 'Global Menu', 'lightning-pro' ),
					'selector' => '.gMenu',
				),
				'title' => array(
		...
		public static function register( $wp_customize ) {
			...
			$html  = '<ul>';
			$html .= '<li>' . __( 'If you want to apply the same font on mobile devices, please select web font (Google Fonts).', 'lightning-pro' ) . '</li>';
			$html .= '<li>' . __( 'The web font (Google Fonts) loads the font data, so the display will be slightly late.', 'lightning-pro' ) . '</li>';
			$html .= '</ul>';
			...
			foreach ( $targets as $key => $label ) {
				...
				$wp_customize->add_control(
					'vk_font_selector[' . $key . ']',
					array(
						'label'    => __( $label . ':', 'lightning-pro' ),
						'section'  => 'vk_font_selector_related_setting',
						'settings' => 'vk_font_selector[' . $key . ']',
						'type'     => 'select',
						'choices'  => $choices,
					// 'choices'  => array(
					// 'mincho' => __( 'Mincho', 'lightning-pro' ),
					// 'gothic' => __( 'Gothic', 'lightning-pro' ),
					// ),
					)
				);
			}
