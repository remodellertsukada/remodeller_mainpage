	...
	class VK_Headding_Design {
		...
		public static function get_headding_style_array( $color_key = '#c00' ) {
			...
			$styles                       = array(
				...
				'plain_center'                    => array(
					'label'  => __( 'Plain ( Align center )', 'lightning-pro' ),
					'inner'  => 'color:#333;',
				...
				'speech_balloon_fill'             => array(
					'label'  => __( 'Speech balloon fill', 'lightning-pro' ),
					'inner'  => 'color:#fff;',
					'normal' => $reset . '
				...
				'background_fill'                 => array(
					'label'  => __( 'Background fill', 'lightning-pro' ),
					'inner'  => 'color:#fff;',
					'normal' => $reset . '
						background-color:' . $color_key . ';
				...
				'background_fill_stitch'          => array(
					'label'  => __( 'Background fill stitch', 'lightning-pro' ),
					'inner'  => 'color:#fff;',
					'normal' => $reset . '
						background-color:' . $color_key . ';
						padding: 0.6em 0.7em 0.5em;
				...
				'background_fill_lightgray'       => array(
					'label'  => __( 'Background fill lightgray', 'lightning-pro' ),
					'inner'  => 'color:#333;',
					'normal' => $reset . '
						color: #333;
				...
				'topborder_background_fill_none'  => array(
					'label'  => __( 'Top border keycolor background fill none', 'lightning-pro' ),
					'inner'  => 'color:#333;',
					'normal' => $reset . '
						color: #333;
				...
				'topborder_background_fill_black' => array(
					'label'  => __( 'Top border keycolor background fill black', 'lightning-pro' ),
					'inner'  => 'color:#fff;',
					'normal' => $reset . '
				...
				'double_black'                    => array(
					'label'  => __( 'Double black', 'lightning-pro' ),
					'inner'  => 'color:#333;',
					'normal' => $reset . '
						color:#333;
						padding: 0.6em 0 0.5em;
				...
				'double_bottomborder'             => array(
					'label'  => __( 'Double bottom border', 'lightning-pro' ),
					'inner'  => 'color:#333;',
					'normal' => $reset . '
						color:#333;
						padding: 0.6em 0 0.5em;
				...
				'double_bottomborder_black'       => array(
					'label'  => __( 'Double bottom border black', 'lightning-pro' ),
					'inner'  => 'color:#333;',
					'normal' => $reset . '
						color:#333;
						padding: 0.6em 0 0.5em;
				...
				'solid_black'                     => array(
					'label'  => __( 'Solid black', 'lightning-pro' ),
					'inner'  => 'color:#333;',
					'normal' => $reset . '
						color:#333;
						padding: 0.6em 0 0.5em;
				...
				'solid_bottomborder'              => array(
					'label'  => __( 'Solid bottom border', 'lightning-pro' ),
					'inner'  => 'color:#333;',
					'normal' => $reset . '
						color:#333;
						padding: 0.6em 0 0.5em;
				...
				'solid_bottomborder_black'        => array(
					'label'  => __( 'Solid bottom border black', 'lightning-pro' ),
					'inner'  => 'color:#333;',
					'normal' => $reset . '
						color:#333;
						padding: 0.6em 0 0.5em;
				...
				'solid_bottomborder_leftkeycolor' => array(
					'label'  => __( 'Solid bottom border left keycolor', 'lightning-pro' ),
					'inner'  => 'color:#333;',
					'normal' => $reset . '
						color:#333;
						padding: 0.6em 0 0.5em;
				...
				'dotted_bottomborder_black'       => array(
					'label'  => __( 'Dotted bottom border black', 'lightning-pro' ),
					'inner'  => 'color:#333;',
					'normal' => $reset . '
						color:#333;
						padding: 0.6em 0 0.5em;
				...
				'both_ends'                       => array(
					'label'  => __( 'Both ends', 'lightning-pro' ),
					'inner'  => 'color:#333;',
					'normal' => $reset . '
						color:#333;
						border:none;
				...
				'leftborder'                      => array(
					'label'  => __( 'Left border', 'lightning-pro' ),
					'inner'  => 'color:#333;',
					'normal' => $reset . '
						color:#333;
						padding: 0.6em 0.7em 0.5em;
				...
				'leftborder_nobackground'         => array(
					'label'  => __( 'Left border nobackground', 'lightning-pro' ),
					'inner'  => 'color:#333;',
					'normal' => $reset . '
						color:#333;
						border:none;
				...
				'diagonal_stripe_bottomborder'    => array(
					'label'  => __( 'Diagonal stripe bottom border', 'lightning-pro' ),
					'inner'  => 'color:#333;',
					'normal' => $reset . '
						color:#333;
				...
				'brackets'                        => array(
					'label'  => __( 'Brackets', 'lightning-pro' ),
					'inner'  => 'color:#333;',
					'normal' => $reset . '
						color:#333;
						padding: 0.7em;
				...
				'brackets_black'                  => array(
					'label'  => __( 'Brackets black', 'lightning-pro' ),
					'inner'  => 'color:#333;',
					'normal' => $reset . '
						color:#333;
						padding: 0.7em;
				...
				'small_bottomborder'              => array(
					'label'  => __( 'Small bottom border', 'lightning-pro' ),
					'inner'  => 'color:#333;',
					'normal' => $reset . '
						color:#333;
						padding: 0;
		...
		public static function customize_register( $wp_customize ) {
			...
			$wp_customize->add_control(
				new Custom_Html_Control(
					...
					'vk_headding_design',
					array(
						'label'            => __( 'Headding Design', 'lightning-pro' ),
						'section'          => $headding_customize_section,
						'type'             => 'text',
						'custom_title_sub' => '',
						'custom_html'      => __( '※ 配置する場所の背景色などの都合で適切に見えないものがあります。', 'lightning-pro' ),
						'priority'         => 710,
			...
			$choices = array(
				'none' => __( 'No setting', 'lightning-pro' ),
			);
